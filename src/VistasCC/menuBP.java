...
public class menuBP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("MENU BODEGA PLASTICO");
        setIconImage(getIconImage());
        setMaximumSize(new java.awt.Dimension(1500, 946));
        ...
        jMenuItem2.setText("NOTAS CREDITO");
        ...
        jMenuItem3.setText("SOBRANTES & FALTANTES");
        ...
        jMenuItem5.setText("CONSULTA PLASTICO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuBP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
